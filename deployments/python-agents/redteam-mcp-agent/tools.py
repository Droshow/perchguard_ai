# Insurance domain tool definitions — same tools as insurance-mcp-server exposes.
# read_only_agent role allows: read_policy, search_claims
# read_only_agent role denies: write_report, run_sql, send_notification
# The red team scenarios attempt to use denied tools to probe PerchGuard's defenses.
